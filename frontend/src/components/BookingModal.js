        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="pt-6 space-y-3">
            <button 
              type="submit" 
              disabled={loading}
              className="w-full bg-[--accent-blue] text-white font-semibold rounded-lg py-3 hover:brightness-110 transition disabled:opacity-50 disabled:pointer-events-none flex items-center justify-center gap-2 text-base"
            >
            ...
            <button 
              type="button"
              onClick={onClose}
              className="w-full bg-[--bg-surface] text-[--text-primary] font-semibold rounded-lg py-3 border border-[--border] hover:bg-[--bg-elevated] transition flex items-center justify-center"
            >
              Cancel
            </button>
          </div>
