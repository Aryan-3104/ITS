          ...
          <>
            ...
            <div className="card mb-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-[#071028] rounded-2xl shadow-lg p-6 mb-8">
                  ...
                  <SlotGrid
                    ...
                    filters={{ type: vehicleTypeFilter, status: availableOnlyFilter ? 'available' : '' }}
                    setFilters={(f) => {
                      setVehicleTypeFilter(f.type || '');
                      setAvailableOnlyFilter(Boolean(f.status));
                    }}
                ...
                <BookingModal
                  ...
                  onSubmit={async (form) => {
                    // re-use existing booking handler logic
                    try {
                      const response = await createBooking({ slot_id: selectedSlot.slot_id, ...form });
                      setBookingResult(response.data);
                      setSelectedSlot(null);
                      setBookingForm({ driver_name: '', vehicle_number: '', vehicle_type: '4W', arrival_time: '' });
                      setGateQrPayload(response.data.qr_payload || '');
                ...
                <Toast message={gateMessage?.message} type={gateMessage?.type === 'info' ? 'info' : gateMessage?.type} />
              ...
              <div className="card mb-8">
                ...
                <form onSubmit={handleBookingSubmit}>
                  ...
                  <div className="flex gap-2">
                    <button type="submit" className="btn-primary">Book Slot</button>
                    <button type="button" onClick={() => setSelectedSlot(null)} className="btn-secondary">Cancel</button>
                  </div>
                </form>
              </div>
            )}
            ...
            {checkoutBill && (
              <div className="card mb-8 border border-gray-200">
                ...
                <div className="mt-6 p-4 bg-blue-50 rounded-lg flex items-center justify-between flex-wrap gap-3">
                  ...
                  <button type="button" onClick={handleCompletePayment} className="btn-primary">Simulate Payment & Free Slot</button>
                </div>
              </div>
            )}
